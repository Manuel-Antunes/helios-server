...
ALLOWED_HOSTS = get_from_env('ALLOWED_HOSTS', 'voto.uncisal.edu.br').split(",")
...
URL_HOST = get_from_env("URL_HOST", "https://voto.uncisal.edu.br").rstrip("/")
...
# Email server modificado - SUTIN
DEFAULT_FROM_EMAIL = 'voto@uncisal.edu.br'
EMAIL_HOST = '*****'
EMAIL_HOST_USER = 'voto@uncisal.edu.br'
EMAIL_HOST_PASSWORD = '*****'
EMAIL_PORT = *****
EMAIL_USE_TLS = True
...
#LDAP modificado - SUTIN
AUTH_LDAP_SERVER_URI = '*****'
AUTH_LDAP_BASE_DN = '*****'
AUTH_LDAP_BIND_DN = '*****'
AUTH_LDAP_BIND_PASSWORD = '*****'
AUTH_LDAP_USER_SEARCH = LDAPSearch(
    AUTH_LDAP_BASE_DN, ldap.SCOPE_SUBTREE, '*****')
